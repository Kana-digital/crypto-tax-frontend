    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <h3>1. 基本方針</h3>
          <p>本ツール（以下「本ツール」）は、利用者のプライバシーを尊重し、個人情報の保護に努めます。本ツールは暗号資産の損益計算を行う無料サービスです。</p>

          <h3>2. アップロードデータの取り扱い</h3>
          <p>利用者がアップロードするCSVファイルは、損益計算の処理のみに使用されます。アップロードされたデータはサーバーに保存されず、処理完了後に即座に破棄されます。本ツールはお客様の取引データを収集・保管・第三者提供しません。</p>

          <h3>3. アクセス解析ツール（Google Analytics）</h3>
          <p>本ツールはサービス改善のため、Google Analytics（GA4）を使用しています。Google Analyticsはトラフィックデータの収集のためにCookieを使用しており、このデータは匿名で収集されます。個人を特定する情報は含まれません。</p>
          ...
          <p>本ツールでは、暗号資産取引所へのアフィリエイトリンクを掲載しています（「PR」と表示）。アフィリエイトリンクを経由して口座開設が行われた場合、本ツールに報酬が支払われることがあります。利用者がリンクをクリックした場合、各取引所のプライバシーポリシーが適用されます。</p>

          <h3>5. 免責事項</h3>
          <p>本ツールの計算結果は参考値であり、税務申告等の正式な書類としてそのまま使用することはできません。計算結果の正確性について本ツールは一切の責任を負いません。確定申告については税務署または税理士にご相談ください。</p>

          <h3>6. プライバシーポリシーの変更</h3>
          <p>本ツールは、必要に応じて本プライバシーポリシーを変更することがあります。変更後のポリシーは本ページに掲載した時点から効力を生じます。</p>
      ...
      <main className="app-container">
        ...
        <div className="notice-box" style={{ marginTop: 16 }}>
          ...
          <ol>
            ...
            <li>本ツールの利用により生じた損害について、本ツールは一切の責任を負いません。</li>
          </ol>
        </div>
